...
class Qwen3MoeForSequenceClassification(Qwen3MoePreTrainedModel):
    """
    1. copied the body from GenericForSequenceClassification
    2. used a modified output class that includes router logits
    """
    base_model_prefix = "model"
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        router_logits = transformer_outputs.router_logits if hasattr(transformer_outputs, "router_logits") else None
